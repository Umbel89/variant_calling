...
if __name__ == '__main__':
    ...
    reference = Pe1
    reference_fasta = f"/net/virus/linuxhome/petros/variant_calling/{reference}/reference/{reference}_assembly.fasta"
    input_vcf = f"/net/virus/linuxhome/petros/variant_calling/{reference}/variants/Pe.vcf.gz"
    output_dir = f"/net/virus/linuxhome/petros/variant_calling/{reference}/variants/"

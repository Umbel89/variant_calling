...
if __name__ == '__main__':
    ...
    reference_fasta = "/net/virus/linuxhome/petros/variant_calling_Pe4/reference/Pe4_corr.fasta"
    input_vcf = "/net/virus/linuxhome/petros/variant_calling_Pe4/variants/Pe4.vcf.gz"
    output_dir = "/net/virus/linuxhome/petros/variant_calling_Pe4/variants/samples/"
